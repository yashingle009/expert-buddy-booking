...
import SetAvailabilityDialog from "@/components/dashboard/SetAvailabilityDialog";
import UpdatePricingDialog from "@/components/dashboard/UpdatePricingDialog";
import MessageTemplatesDialog from "@/components/dashboard/MessageTemplatesDialog";
...
const ExpertDashboard = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Button 
              ...
              onClick={() => toggleDialog("editProfile")}
            >
            ...
            <Button 
              variant="outline" 
              className="w-full justify-start"
              onClick={() => toggleDialog("setAvailability")}
            >
            ...
            <Button 
              variant="outline" 
              className="w-full justify-start"
              onClick={() => toggleDialog("updatePricing")}
            >
            ...
            <Button 
              variant="outline" 
              className="w-full justify-start"
              onClick={() => toggleDialog("messageTemplates")}
            >
      ...
      <EditProfileDialog 
        open={dialogState.editProfile} 
        onOpenChange={(open) => setDialogState(prev => ({ ...prev, editProfile: open }))}
      />
      
      <SetAvailabilityDialog 
        open={dialogState.setAvailability}
        onOpenChange={(open) => setDialogState(prev => ({ ...prev, setAvailability: open }))}
      />
      
      <UpdatePricingDialog 
        open={dialogState.updatePricing}
        onOpenChange={(open) => setDialogState(prev => ({ ...prev, updatePricing: open }))}
      />
      
      <MessageTemplatesDialog 
        open={dialogState.messageTemplates}
        onOpenChange={(open) => setDialogState(prev => ({ ...prev, messageTemplates: open }))}
      />
    </div>
  );
};
